...
export default function ProductReviewInsights() {
  ...
  // ✅ Fetch backend OR fallback to demo data
  useEffect(() => {
    async function fetchInsights() {
      try {
        ...
        if (
          !data.customerStories?.length &&
          !data.productsNeedingAttention?.length
        ) {
          console.warn("⚠️ No backend data — using demo data.");
          loadDemoData();
        } else {
      ...
      setCustomerStories([
        {
          ...
          review:
            "Absolutely love this product! The quality exceeded my expectations and the customer service was fantastic.",
        ...
        },
        {
          ...
          sentimentType: "mixed",
          review:
            "Good daily product overall, but the battery life could be better. Works as expected though.",
        ...
        },
        {
          ...
          review:
            "Had some major issues with connectivity. Support team was helpful but took a while to resolve.",
        ...
        },
        {
          ...
          sentimentType: "positive",
          review:
            "Perfect for my daily workouts! Comfortable fit and great battery life. Highly recommend!",
  ...
  const getSentimentColor = (sentiment, type) => {
    ...
    if (type === "mixed" || (sentiment >= 50 && sentiment < 80))
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-4">
                  ...
                  <p className="text-gray-300 text-lg">
                    Outstanding customer satisfaction with 94% positive
                    sentiment and consistently high ratings.
                  </p>
