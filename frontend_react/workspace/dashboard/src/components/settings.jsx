    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0B0C2A] via-[#1a0f3a] to-[#2C0E4E] text-white px-6 md:px-10 py-10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* === User Profile === */}
          <div className="glass-card p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md shadow-lg hover:shadow-[0_0_20px_rgba(157,78,221,0.3)] transition-all">
            <div className="flex items-center gap-3 mb-6">
              <User className="w-6 h-6 text-[#00E7F9]" />
              <h2 className="text-2xl font-semibold">User Profile & Preferences</h2>
            </div>
            ...
            <button className="w-full mb-6 px-6 py-3 rounded-xl bg-gradient-to-r from-[#9D4EDD]/20 to-[#9D4EDD]/10 border border-[#9D4EDD]/50 font-semibold hover:shadow-[0_0_20px_rgba(157,78,221,0.5)] hover:scale-[1.02] transition-all duration-300">
              Edit Profile
            </button>
            ...
            <div className="space-y-4">
              ...
              />
              <div className="setting-row group justify-between">
                <div className="flex items-center gap-3">
                  <Globe className="w-5 h-5 text-[#00E7F9]" />
                  <span className="text-[#CFCFEF] group-hover:text-white">Language</span>
                </div>
                <select
                  value={language}
          ...
          {/* === System Settings === */}
          <div className="glass-card p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md shadow-lg hover:shadow-[0_0_20px_rgba(0,231,249,0.3)] transition-all">
            <div className="flex items-center gap-3 mb-6">
            ...
            <div className="space-y-4">
              <SettingDropdown
                icon={<RefreshCw className="w-5 h-5 text-[#9D4EDD]" />}
              ...
              />
              <SettingDropdown
                icon={<AlertTriangle className="w-5 h-5 text-[#00E7F9]" />}
          ...
          <div className="glass-card p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md shadow-lg hover:shadow-[0_0_20px_rgba(157,78,221,0.3)] transition-all">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-semibold">Privacy & Permissions</h2>
            </div>
            ...
            <div className="space-y-4">
              ...
              <SettingButton
                ...
                extraClasses="hover:border-red-500/50 hover:shadow-[0_0_15px_rgba(239,68,68,0.3)]"
              />
            </div>
          </div>
          ...
          <div className="glass-card p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md shadow-lg hover:shadow-[0_0_20px_rgba(0,231,249,0.3)] transition-all">
            ...
            <button className="w-full px-6 py-3 rounded-xl bg-gradient-to-r from-[#9D4EDD]/20 to-[#00E7F9]/20 border border-[#9D4EDD]/50 text-white font-semibold hover:shadow-[0_0_25px_rgba(157,78,221,0.5)] transition-all duration-300">
              Apply Theme
            </button>
          </div>
        </div>
...
function SettingDropdown({ icon, label, value, onChange, options }) {
  return (
    <div className="setting-row flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 transition-all">
      <div className="flex items-center gap-3">
        {icon}
        <span className="text-[#CFCFEF]">{label}</span>
      </div>
      <select
        ...
        className="px-3 py-2 rounded-lg bg-transparent border border-[#9D4EDD]/30 text-white text-sm focus:border-[#9D4EDD] outline-none transition-all"
      >
        {options.map((opt) => (
